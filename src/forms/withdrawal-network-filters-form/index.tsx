...
} from "./withdrawal-network-filters-form.consts";

interface WithdrawalNetworkFiltersFormProps {
  onChange: (values: WithdrawalNetworkFiltersFormValues) => void;
}

export const WithdrawalNetworkFiltersForm: FC<WithdrawalNetworkFiltersFormProps> = ({ onChange }) => {
  const form = useForm({
    defaultValues: emptyWithdrawalNetworkFilters,
  });
  const { Field } = form;
