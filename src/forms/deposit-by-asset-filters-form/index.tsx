...
import { DepositByAssetFiltersFormValues, emptyDepositByAssetFilters } from "./deposit-by-asset-filters-form.consts";

interface DepositByAssetFiltersFormProps {
  onChange: (values: DepositByAssetFiltersFormValues) => void;
}

export const DepositByAssetFiltersForm: FC<DepositByAssetFiltersFormProps> = ({ onChange }) => {
  const form = useForm({
    defaultValues: emptyDepositByAssetFilters,
  });
  const { Field } = form;
